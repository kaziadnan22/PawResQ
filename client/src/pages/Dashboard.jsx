...
import { rescuedPetsAPI, usersAPI } from '../services/api';
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', mb: { xs: 2, sm: 0 } }}>
          ...
          <Box>
            ...
            <Typography variant="body1">
              {currentUser ? `You are logged in as a ${currentUser.role}` : 'Please login to access all features'}
            </Typography>
          </Box>
        </Box>
        <Typography variant="body2" textAlign={{ xs: 'center', sm: 'right' }}>
          Together we can make a difference in animals' lives
        </Typography>
      </Paper>
